...
if ($res->num_rows > 0) {
    ...
    while ($row = $res->fetch_assoc()) {
        ...
        echo "<td>";
        if (isset($_SESSION["AID"])) { // Only Admin can see edit & delete options
            echo "<button onclick=\"openEditModal('{$row["BID"]}', '{$row["BTITLE"]}', '{$row["KEYWORDS"]}', '{$row["FILE"]}')\">Edit</button> ";
            echo "<a href='deletebook.php?id={$row["BID"]}' onclick='return confirm(\"Are you sure you want to delete this book?\")'>
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editForm" enctype="multipart/form-data">
            ...
            <input type="file" id="file" name="efile"><br><br>

            <button type="button" onclick="submitEditForm()">Save Details</button>
        </form>
    </div>
</div>
</main>
    ...
    <script>
        ...
        function openEditModal(id, title, keywords, file) {
